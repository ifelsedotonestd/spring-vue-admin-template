...
import one.ifelse.module.base.domain.authority.AuthorityRepository
import one.ifelse.module.base.domain.group.GroupRepository
import one.ifelse.module.base.domain.user.PasswordGenerator
import one.ifelse.module.base.domain.user.User
import one.ifelse.module.base.domain.user.UserRepository
        ...
        userRepo.findById(ReservedUser.ADMIN.id).ifPresentOrElse(
            {
                ...
                val adminAuthorities =
                    authorityRepo.findAllByCodeIsIn(ReservedAuthority.values().map { it.code }).toHashSet()
